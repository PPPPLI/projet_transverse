<template>
    <div id="firstDiv">
        ...
        <pre id="span11" class="spanAnimal">
            ...
            Date de découverte:   <span>{{animals[8]}}</span><br>
        ...
        <img id="img2" src="../assets/upload/5.jpg" class="imgAnimal">
        <pre id="span2" class="spanAnimal">
            Type:    <span>Chien</span><br>
            Sexe:    <span>Mâle</span><br>
            Color:   <span>Blanc</span><br>
            Race:    <span>Caniche</span><br>
            Etat:    <span>Retrouvé</span>
        </pre>
        <pre id="span22" class="spanAnimal">
            Ville:    <span>Annemasse</span><br>
            Code postal:    <span>74100</span><br>
            Rue:    <span>20 Rue de vannes</span><br>
            Date de découverte:    <span>2023-04-14</span><br>
        ...
        <img id="img3"  src="../assets/upload/6.jpg" class="imgAnimal">
        <pre id="span3" class="spanAnimal">
            Type:    <span>Chat</span><br>
            Sexe:    <span>Mâle</span><br>
            Color:   <span>Noir et blanc</span><br>
            Race:    <span>Chat de la maison</span><br>
            Etat:    <span>Retrouvé</span>
        </pre>
        <pre id="span33" class="spanAnimal">
            Ville:    <span>Paris</span><br>
            Code postal:    <span>75012</span><br>
            Rue:    <span>Près de gare de Lyon</span><br>
            Date de découverte:    <span>2023-04-03</span><br>
            Description:    <span>Test</span>
        </pre>
        ...
        <img id="img4" src="../assets/upload/7.jpg" class="imgAnimal">
        ...
        <pre id="span44" class="spanAnimal">
            Ville:    <span>Roubaix</span><br>
            Code postal:    <span>59100</span><br>
            Rue:   <span>20 Rue de rospierre</span><br>
            Date de découverte:    <span>2022-01-16</span><br>
            Description:    <span>Test</span>
        </pre>
        ...
        <img id="img5"  src="../assets/upload/8.jpg" class="imgAnimal">
        <pre id="span5" class="spanAnimal">
            Type:    <span>Chat</span><br>
            Sexe:    <span>Femelle</span><br>
            Color:   <span>Tricolore</span><br>
            Race:    <span>Maine Coon</span><br>
            Etat:    <span>Retrouvé</span>
        </pre>
        <pre id="span55" class="spanAnimal">
            Ville:    <span>Rouen</span><br>
            Code postal:    <span>76000</span><br>
            Rue:    <span>50 rue de choisy</span><br>
            Date de découverte:    <span>2023-01-17</span><br>
            Description:    <span>Test</span>
        </pre>
